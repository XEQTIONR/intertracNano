                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="form-group" :class="{'has-error' : errors.customer && customer==null}">
                      ...
                      <p style="font-weight: bold; font-style: italic">@{{ customer.name }}</p>
  ...
  <script>
      ...
      var app = new Vue({
          ...
          data: {
              ...
              tax_percent : parseFloat("{{$order->tax_percentage}}"),
          ...
          mounted : function() {
              ...
              var order_contents = JSON.parse('{!! json_encode($order_contents) !!}');
              console.log(order_contents);

              var j=0;

              while(j<order_contents.length) {
                  this.add(order_contents[j].i);
                  this.order_contents[j].qty = parseInt(order_contents[j].qty);
                  this.order_contents[j].unit_price = parseFloat(order_contents[j].unit_price);
